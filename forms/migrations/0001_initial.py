    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('married', models.IntegerField(choices=[(1, 'विवाहित'), (2, 'अविवाहित'), (3, 'सम्बन्धविच्छेद भएको')])),
                ('mobile_number', models.CharField(blank=True, max_length=17, null=True, unique=True, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.", regex='^(\\+\\d{1,3})?,?\\s?\\d{8,13}')])),
